    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-5 col-12 mb-5">
                ...
                <h2 class="text-white">Welcome to <br>{{ $university->university_name }}</h2>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-12 m-auto">
                <h3 class="mb-4">Introduction to {{ $university->university_name }}</h3>
                <p>{{ $programs->program_name }}</p>
                <h4>Requirements for this Program</h4>
